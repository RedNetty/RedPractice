package com.rednetty.redpractice.utils.particles;
...
public final class ReflectionUtils {
     ...
     *
     * @param clazz     Target class
     * @param arguments Arguments which are used to construct an  of the target class
     ...
     * @param className   Name of the desired target class
     * @param packageType Package where the desired target class is located
     * @param arguments   Arguments which are used to construct an  of the desired target class
    ...
    /**
     * Invokes a method on an  with the given arguments
     *
     * @param instance   Target
     * @param methodName Name of the desired method
     * @param arguments  Arguments which are used to invoke the desired method
     * @return The result of invoking the desired method on the target
     ...
     * @throws NoSuchMethodException     If the desired method of the class of the target  with the specified name and arguments cannot be found
     * @see #getMethod(Class, String, Class...)
    ...
    /**
     * Invokes a method of the target class on an  with the given arguments
     *
     * @param instance   Target
     * @param clazz      Target class
     * @param methodName Name of the desired method
    ...
    /**
     * Invokes a method of a desired class on an  with the given arguments
     *
     * @param instance    Target
     * @param className   Name of the desired target class
     * @param packageType Package where the desired target class is located
    ...
    /**
     * Returns the value of a field of the given class of an
     *
     * @param instance  Target
     * @param clazz     Target class
     * @param declared  Whether the desired field is declared or not
     * @param fieldName Name of the desired field
     * @return The value of field of the target
     * @throws IllegalArgumentException If the target  does not feature the desired field
    ...
    /**
     * Returns the value of a field of a desired class of an
     *
     * @param instance    Target
     * @param className   Name of the desired target class
     * @param packageType Package where the desired target class is located
    ...
    /**
     * Returns the value of a field with the given name of an
     *
     * @param instance  Target
     * @param declared  Whether the desired field is declared or not
     * @param fieldName Name of the desired field
     * @return The value of field of the target
     * @throws IllegalArgumentException If the target  does not feature the desired field (should not occur since it searches for a field with the given name in the class of the )
     * @throws IllegalAccessException   If the desired field cannot be accessed
     * @throws NoSuchFieldException     If the desired field of the target  cannot be found
     * @throws SecurityException        If the desired field cannot be made accessible
     * @see #getValue(Object, Class, boolean, String)
     */
    ...
    /**
     * Sets the value of a field of the given class of an
     *
     * @param instance  Target
     * @param clazz     Target class
     * @param declared  Whether the desired field is declared or not
    ...
    /**
     * Sets the value of a field of a desired class of an
     *
     * @param instance    Target
     * @param className   Name of the desired target class
     * @param packageType Package where the desired target class is located
    ...
    /**
     * Sets the value of a field with the given name of an
     *
     * @param instance  Target
     * @param declared  Whether the desired field is declared or not
     * @param fieldName Name of the desired field
    ...
    public enum DataType {
        ...
        /**
         * Returns the primitive class array of the given  array
         *
         * @return The primitive class array
         */
        public static Class<?>[] getPrimitive(Object[] s) {
            int length = s == null ? 0 : s.length;
            Class<?>[] types = new Class<?>[length];
            for (int index = 0; index < length; index++) {
                types[index] = getPrimitive(s[index].getClass());
            }
            return types;
        }

        /**
         * Returns the reference class array of the given  array
         *
         * @return The reference class array
         */
        public static Class<?>[] getReference(Object[] s) {
            int length = s == null ? 0 : s.length;
            Class<?>[] types = new Class<?>[length];
            for (int index = 0; index < length; index++) {
                types[index] = getReference(s[index].getClass());
            }
            return types;
        }
